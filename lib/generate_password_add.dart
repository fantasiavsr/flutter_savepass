...
class GenerateAddPassword extends StatefulWidget {
  ...
  @override
  State<GenerateAddPassword> createState() => _GenerateAddPasswordState();
}

class _GenerateAddPasswordState extends State<GenerateAddPassword> {
  @override
